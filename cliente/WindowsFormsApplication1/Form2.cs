...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        private List<int> casillasJugador = new List<int>();      //Lista casillas ocupadas por cada jugador
        private List<string> Jugadors = new List<string>();       //Lista nombre de los jugadores de la partida
        ...
        private float resolution = 1.0f;     //Resolucion del tablero
        private float time = DateTime.Now.Hour * 60 + DateTime.Now.Minute + DateTime.Now.Second / 60; //Tiempo actual en minutos

        bool pozo1 = false, pozo2 = false, pozo3 = false, pozo4 = false; // Indicar si un jugador ha caído en un pozo
        ...
        {
            CrearTablero();  //Inicializar tablero
            ConfigurarChat();  //Configuracion del chat
            AsignarJugadores();  //Configuración de los jugadores
        ...
        // Asigna los jugadores según la disponibilidad
        ...
        private void CrearTablero()
        {
            ...
            //Funció per pintar en el tablero
            tablero.Paint += new PaintEventHandler(tablero_Paint);  
        }
